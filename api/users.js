...
const GIT_TOKEN = process.env.GIT_TOKEN; // just a plain ol' made-up token
const TRELLO_TOKEN = process.env.TRELLO_TOKEN; // just another plain ol' made-up token
const EMAIL_TOKEN = process.env.EMAIL_TOKEN; // made-up token
